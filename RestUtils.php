...
class RestUtils
{
	...
	public static function getHTMLBody($content)
	{
		return RestUtils::getHTTPHeader() . $content . RestUtils::getHTTPFooter(); 
	}
	
	public static function getPrintTestArray($array)
	{
		return RestUtils::getHTMLBody("<pre>" . print_r($arrary, false) . "</pre>");
	}
}
?>